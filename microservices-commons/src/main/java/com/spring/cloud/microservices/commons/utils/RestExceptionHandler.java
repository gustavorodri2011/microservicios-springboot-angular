package com.spring.cloud.microservices.commons.utils;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	@ExceptionHandler
	  ...
	  protected ResponseEntity<ErrorResponse> handleException(InvalidDataException exc) {
	    ...
	    return buildResponseEntity(httpStatus, new RuntimeException("Los datos enviados no son válidos"), errors);
	  }
	  ...
	  protected ResponseEntity<ErrorResponse> handleException(MethodArgumentTypeMismatchException exc) {
	    ...
	    // por Integer
	    return buildResponseEntity(httpStatus, new RuntimeException("Tipo de Argumento no válido"));
	  }
	  ...
	  private ResponseEntity<ErrorResponse> buildResponseEntity(HttpStatus httpStatus, Exception exc, List<String> errors) {
	    ...
	    error.setMessage("REST_MSG -" + exc.getMessage());
